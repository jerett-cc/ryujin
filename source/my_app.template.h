...
namespace mgrit{
  ...
  braid_Int MyApp<Number, Description, dim>::Init(braid_Real t, braid_Vector *u_ptr)
  {
    ...
    std::get<0>(u->U) = levels[finest_level]->initial_values->interpolate_hyperbolic_vector(0.0); 
    std::get<0>(temp_coarse->U) = levels[coarsest_level]->initial_values->interpolate_hyperbolic_vector(0.0);
