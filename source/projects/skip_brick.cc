...
int main(int argc, char *argv[]){
  ...
  // the following levels exist where X means that the previous C-point is exact:
  ...
  std::cout << ((app.previous_cpoint_is_exact(0, cycle)) ? "OK":"Not OK") << std::endl; 
  std::cout << ((app.previous_cpoint_is_exact(1, cycle)) ? "OK":"Not OK") << std::endl;
  std::cout << ((app.previous_cpoint_is_exact(2, cycle)) ? "OK":"Not OK") << std::endl;
  std::cout << ((app.previous_cpoint_is_exact(3, cycle)) ? "OK":"Not OK") << std::endl;
  std::cout << ((app.previous_cpoint_is_exact(4, cycle)) ? "Not OK":"OK") << std::endl;
  std::cout << ((app.previous_cpoint_is_exact(5, cycle)) ? "Not OK":"OK") << std::endl;
  std::cout << ((app.previous_cpoint_is_exact(6, cycle)) ? "Not OK":"OK") << std::endl;
  std::cout << ((app.previous_cpoint_is_exact(7, cycle)) ? "Not OK":"OK") << std::endl;
  std::cout << ((app.previous_cpoint_is_exact(8, cycle)) ? "Not OK":"OK") << std::endl;
  std::cout << ((app.previous_cpoint_is_exact(9, cycle)) ? "Not OK":"OK") << std::endl;
  std::cout << ((app.previous_cpoint_is_exact(10, cycle)) ? "Not OK":"OK") << std::endl;
  std::cout << ((app.previous_cpoint_is_exact(11, cycle)) ? "Not OK":"OK") << std::endl;
