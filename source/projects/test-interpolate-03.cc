...
/**
 * Test that a solution remains in the invariant domain (density, entropy, and energy all positive)
 * after interpolation to a coarser level.
 */
...
int main(int argc, char *argv[]){
  ...
  app.time_loops[0]->change_checkpoint_and_frequency_and_basename(false, 0.05, app.base_name);
  ...
  //mgrit_functions:: FIXME: add in the check.
  app.time_loops[1]->change_checkpoint_and_frequency_and_basename(false, 0.05, app.base_name+"coarse");
